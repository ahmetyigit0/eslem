...
.t-card-img{width:100%;position:relative;overflow:hidden;background:#f5e0e4}
.t-card-img img{width:100%;height:auto;display:block;max-height:420px;object-fit:contain}
.t-card-ph{width:100%;height:200px;background:linear-gradient(160deg,#f5e0e4,#ead0d5);
